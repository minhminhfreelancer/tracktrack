export function onRequest(context) {
  ...
  const trackingOptions = optionsParam ? JSON.parse(decodeURIComponent(optionsParam)) : DEFAULT_OPTIONS;
  ...
  function setupClickTracking() {
    if (!trackingOptions.includes('phone_clicks') && 
    ...
    document.addEventListener('click', function(event) {
      ...
      if (trackingOptions.includes('phone_clicks') && href.startsWith('tel:')) {
        trackType = 'phone';
      } else if (trackingOptions.includes('zalo_clicks') && href.includes('zalo.me')) {
        trackType = 'zalo';
      } else if (trackingOptions.includes('messenger_clicks') && href.includes('m.me')) {
        trackType = 'messenger';
      }
